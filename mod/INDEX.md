# GTBikeV - Documentation <!-- omit in toc -->

- [1. About](#1-about)
  - [1.1 Documentation](#11-documentation)
  - [1.2 Supported Version](#12-supported-version)
  - [1.3 What is GTBikeV](#13-what-is-gtbikev)
  - [1.4 Important Notice](#14-important-notice)
- [2. Installation](#2-installation)
  - [2.1 Hardware requirements](#21-hardware-requirements)
  - [2.2 Software requirements](#22-software-requirements)
  - [2.3 Installation guide](#23-installation-guide)
    - [2.3.1 Part I: Install GTA](#231-part-i-install-gta)
    - [2.3.2 Part II: Install Mod](#232-part-ii-install-mod)
    - [2.3.3 Additional Resources](#233-additional-resources)
- [3. Upgrade](#3-upgrade)
- [4. User guide](#4-user-guide)
  - [4.1 Start ride](#41-start-ride)
  - [4.2 End ride](#42-end-ride)
  - [4.2 Configuration](#42-configuration)
  - [4.3 Courses](#43-courses)
    - [4.3.1 About courses](#431-about-courses)
    - [4.3.2 Install courses](#432-install-courses)
- [5. Shortcuts](#5-shortcuts)
  - [5.1 Function keys](#51-function-keys)
  - [5.2 Keyboard keys](#52-keyboard-keys)
  - [5.3 Numpad keys](#53-numpad-keys)
- [6. Troubleshooting](#6-troubleshooting)
  - [6.1 Connection Issue](#61-connection-issue)
- [7. Credits](#7-credits)
...
This document is a collection of information found on [Grand Theft Auto Bike](https://www.facebook.com/groups/1089053124812221) facebook group, YouTube and other sources on the internet.

### 1.2 Supported Version

This documentation supports the following GTBikeV release:
...
`GTBikeV` is a mod for GTA V that turns a Smart Bike Trainer, or cycling power meter, into the game controller, making your game time actual training time. You'll have a cycling workout immersed in the `GTA V` world environment. `GTBikeV` is developed by Nestor Matas (Makinolo) and the project is hosted on [gta5-mods.com](https://www.gta5-mods.com/scripts/gt-bike-v).

### 1.4 Important Notice

> Important: GTBikeV Mod is only supported in GTA V `Story Mode`. If you play the mod in GTA V `Online` then you will be immediatly blocked.
...
2. Install GTA V
3. Play in GTA V in `Story Mode` and complete missions until you reach level 3.

#### 2.3.2 Part II: Install Mod
...
* GTBikeV Mod page: https://www.gta5-mods.com/scripts/gt-bike-v
* Chris Pritchard Cycling News: https://www.youtube.com/watch?v=dbMh9LEGMBg
* GPLama: https://www.youtube.com/watch?v=Bl17P_mpHI0
...
Peform the following steps to end a ride:
